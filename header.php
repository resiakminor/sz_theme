...
<script>
	jQuery(function($) {
		$("div.grid-item, a img").unveil(300);
	});
</script>
<body class="home-back-alt">
		<div class="container trans-back">
			<nav class="navbar-static-top visible-xs-block">
     			<div class="container">
		    	    <div class="logo-mobile">
		    			<a href="<?php echo get_option('home'); ?>">
							<img src="<?php echo get_bloginfo('template_directory');?>/images/szlogo.png" class="logo-alt" alt="Sara Zielinski Logo">
						</a>
					</div>
        			...
        			<div id="navbar" class="navbar-collapse collapse">
          				<ul class="list-style-mobile">
        					...
        					<a href="<?php bloginfo('url'); ?>/prints/">
	        					<li class="nav-style">
	        						<img src="<?php echo get_bloginfo('template_directory');?>/images/nav-prints.png" class="nav-el" alt="Paintings">
	        					</li>
    						</a>
    		...
    		<div class="row">
        		<div id="desktop-nav" class="col-md-3">
		    		<a href="<?php echo get_option('home'); ?>">
						<img src="<?php echo get_bloginfo('template_directory');?>/images/szlogo.png" class="logo-alt" alt="Sara Zielinski Logo">
					</a>
					<nav>
